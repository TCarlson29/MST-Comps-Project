...
NL_csv_files = [
    'filtered_NL_matrices/filtered_Patient1_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient2_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient3_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient4_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient5_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient6_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient7_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient8_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient9_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient10_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient11_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient12_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient13_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient14_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient15_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient16_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient17_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient18_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient19_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient20_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient21_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient22_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient23_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient24_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient25_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient26_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient27_connectivity_matrix.csv', 
    'filtered_NL_matrices/filtered_Patient28_connectivity_matrix.csv', 'filtered_NL_matrices/filtered_Patient29_connectivity_matrix.csv', 
]

# folder for simulated data
simulated_data = 'NL_simulated_data'
